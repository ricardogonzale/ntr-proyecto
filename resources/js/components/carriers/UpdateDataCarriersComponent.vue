                            ...
                            <v-row>
                                ...
                                <v-col cols="12" sm="6" md="6">
                                    <v-select
                                        ...
                                        required
                                        @change="$v.editedItem.country.$touch()"
                        ...
                        <v-col cols="12" sm="12" md="6">
                            <v-row>
                                ...
                                <v-col cols="12" md="12">
                                    <v-textarea
                                        outlined
                                        v-model="editedItem.agency_description"
                                ...
                                <v-col cols="12" sm="6" md="6">
                                    <v-select
                                        ...
                                        "
                                        @blur="$v.editedItem.province.$touch()"
                                ...
                                <v-col cols="12" sm="12" md="6">
                                    <v-text-field
                                        v-model="editedItem.documentation"
                                        label="Dirección sede logística"
                                        outlined
                                    ></v-text-field>
                                </v-col>
                                <v-col cols="12" sm="12" md="6">
                                    <v-file-input
                                        v-model="editedItem.documents_support"
                                        color="deep-purple accent-4"
                                        counter
    ...
    methods: {
        ...
        save() {
            ...
            this.$store
                ...
                .then((res) => {
                    axios.post("/dataCarrier").then((response) => {
