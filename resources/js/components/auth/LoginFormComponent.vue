    ...
    <v-container fluid>
      <v-layout wrap style="margin-top: 20vh;">
        <v-flex sm12 md4 offset-md4>
          <v-card :loading="loginRequestSent" elevation="4" light tag="section">
            <v-card-title class="py-9">
              <v-layout align-center justify-space-between>
                <v-img :alt="platformName" class="mr-3" contain height="48px" src="https://unoynueve.info/dev/ntr/wp-content/uploads/2022/02/logo-ntr-black.svg"></v-img>
              </v-layout>
            </v-card-title>
            <v-divider></v-divider>
            <v-card-text class="text-center py-9">
              ...
              <v-form ref="loginForm">
                <v-text-field
                              ...
                              autofocus
                              :rules="emailRules"
                              :error-messages="errors.email[0]"></v-text-field>
                <v-text-field
                              outline
                              hide-details
                              v-model="password"
            ...
            <v-card-actions :class="{ 'pa-3': $vuetify.breakpoint.smAndUp }">
              ...
              <v-spacer></v-spacer>
              <v-btn class="white--text" color="teal darken-2" :large="$vuetify.breakpoint.smAndUp" :loading="loginRequestSent" @click="login"><v-icon left>mdi-lock</v-icon> Entrar</v-btn>
            </v-card-actions>
          </v-card>
        </v-flex>
        <v-flex sm12 md4 offset-md4>
