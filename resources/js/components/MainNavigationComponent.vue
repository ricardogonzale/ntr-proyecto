  ...
  <v-app id="main-layout">
    ...
    >
       ...
       >
          ...
          <v-list-item-content>
            <v-list-item-title class="text-h6 teal--text text--darken-2">
              GOOD DEALS
            </v-list-item-title>
          </v-list-item-content>
          </v-list-item>
        ...
        >
            <v-list-item-title class="text-h6 grey--text">
                <v-subheader class="blue-grey--text font-weight-bold">OPERACIONES</v-subheader>
            </v-list-item-title>
            <v-list-group
              v-for="item in items"
              :key="item.title"
            ...
            >
              ...
              <v-list-item
                ...
                link
              >
                <v-list-item-title class="teal darken-2--text" v-text="subItem.title"></v-list-item-title>
      ...
      <v-container fluid class="grey lighten-4">
        ...
        <main style="width: 100%;">
          ...
          <v-toolbar style="border-radius: 5px;">
            <v-app-bar-nav-icon v-show="mini" @click="drawer = !drawer"></v-app-bar-nav-icon>
              <router-link
                to="/"
              >
                <v-tooltip
              ...
              <div class="text-right mr-2">
                <small><span class="font-weight-bold" v-text="currentDate"></span></small>
                <br>
                <v-icon small v-if="onLine != false" color="green">mdi-wifi</v-icon>
                <v-icon small v-else color="red">mdi-wifi-off</v-icon>
                <small><span v-text="currentTime"></span></small>
              </div>
              <v-divider
                class="mx-4"
                vertical
          ...
          <br>
          <v-overlay opacity= 0.7 :value="onLine == false" class="text-center">
            <v-icon x-large color="red">mdi-wifi-off</v-icon>
            <p>Sin conexión a internet</p>
            <v-divider></v-divider>
          </v-overlay>
          <v-overlay opacity= 0.7 :value="this.$store.state.loadpage">
            <v-progress-circular
              :size="70"
              :width="7"
              color="purple"
