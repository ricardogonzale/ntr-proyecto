							...
							<div class="container">
								...
								<div class="topbar header-content-menu user-content">
                                    ...
                                    <ul class="d-none d-lg-flex nav align-self-end ml-auto mr-4 font-size-lg" role="tablist">
										...
										<li class="nav-item">
											<a href="/registercli/" class="nav-link btn-agencia py-3 px-4">Registro de cliente</a>
										</li>
										<li class="nav-item">
											<a href="/registercar/" class="nav-link btn-agencia py-3 px-4">Registro de transportista</a>
										</li>
										<li class="nav-item">
											<a href="distribuidor-publicar.html" class="nav-link btn-distribuidor py-3 px-4">Publicar envío</a>
										</li>
										<li class="nav-item">
											<a href="/" class="nav-link btn-entrar py-3 px-4"><i class="la la-user"></i></a>
										</li>
									</ul>
								</div>
							</div>
